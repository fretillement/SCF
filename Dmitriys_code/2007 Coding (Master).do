...
generate newx6484 = x6484
replace newx6484 = newx6484 * 12 if x6485 == 4
replace newx6484 = 0 if newx6484<0

generate newx6489 = x6489 //last variable doesn't have any monthly observations//
replace newx6489 = 0 if newx6489<0
...
generate newx6989 = x6989
replace newx6989 = 0 if newx6989<0

generate newx6995 = x6995 //the last 2 variables don't need to be replaces because they don't have monthly observations//
replace newx6995 = 0 if newx6995<0

         //2) Generate Retirement Withdrawals variable//

generate retirement = 0
foreach x of varlist x6558 x6566 x6574 newx6464- newx6995 {
...
generate income2 = 1 in 1/3171
replace income2 = 2 in 3172/6303
replace income2 =3 in 6304/9591
replace income2 =  4 in 9592/13037
replace income2 = 5 in 13038/15085
replace income2 = 6 in 15086/22090
...
generate current_pension = x6462+x6467+x6472+x6477+x6482+x6487+x6957
...
replace job_pension1 = x11032 if (x11000==5 | x11000==6 | x11000==10 | x11000==21 ///
...
replace job_pension2 = x11132 if (x11100==5 | x11100==6 | x11100==10 | x11100==21 ///
...
replace job_pension3 = x11232 if (x11200==5 | x11200==6 | x11200==10 | x11200==21 ///
   | x11201==2 | x11201==3 | x11201==4 | x11201==6 | x11201==20 | x11201==21 ///
   | x11201==22 | x11201==26 | x11225==1 | x11231==1)          
replace job_pension3 = 0 if x11232==-1

generate job_pension4 = 0
replace job_pension4 = x11332 if (x11300==5 | x11300==6 | x11300==10 | x11300==21 ///
...
replace job_pension5 = x11432 if (x11400==5 | x11400==6 | x11400==10 | x11400==21 ///
...
replace job_pension6 = x11532 if (x11500==5 | x11500==6 | x11500==10 | x11500==21 ///
   | x11501==2 | x11501==3 | x11501==4 | x11501==6 | x11501==20 | x11501==21 ///
   | x11501==22 | x11501==26 | x11525==1 | x11531==1)          
replace job_pension6 = 0 if x11532==-1
...
generate peneq1 = 0
replace peneq1 = peneq1 + job_pension1*(x11036==1 + (x11036==3)*(x11037/10000))

generate peneq2 = 0
replace peneq2 = peneq2 + job_pension2*(x11136==1 + (x11136==3)*(x11137/10000))

generate peneq3 = 0
replace peneq3 = peneq3 + job_pension3*(x11236==1 + (x11236==3)*(x11237/10000))

generate peneq4 = 0
replace peneq4 = peneq4 + job_pension4*(x11336==1 + (x11336==3)*(x11337/10000))

generate peneq5 = 0
replace peneq5 = peneq5 + job_pension5*(x11436==1 + (x11436==3)*(x11437/10000))

generate peneq6 = 0
replace peneq6 = peneq6 + job_pension6*(x11536==1 + (x11536==3)*(x11537/10000))
...
replace pmopup = x11259 if (x11259>0 & (x11000==5 | x11000==6 | x11000==10 | x11000==21 ///
                                     | x11100==5 | x11100==6 | x11100==10 | x11100==21 ///
									 | x11200==5 | x11200==6 | x11200==10 | x11200==21 ///
	...
	| x11201==2 | x11201==3 | x11201==4 | x11201==6 | x11201==20 | x11201==21 | x11201==22 | x11201==26 ///
	| x11031==1 | x11131==1 | x11231==1 | x11025==1 | x11125==1 | x11225==1))
	
replace pmopup = 0 if (x11259>0 & x11000~=0 & x11100~=0 & x11200~=0 & x11031~=0 & x11131~=0 & x11231~=0)

replace pmopup = x11559 if x11559>0
replace pmopup = x11559 if (x11559>0 & (x11300==5 | x11300==6 | x11300==10 | x11300==21 ///
                                     | x11400==5 | x11400==6 | x11400==10 | x11400==21 ///
									 | x11500==5 | x11500==6 | x11500==10 | x11500==21 ///
	...
	| x11501==2 | x11501==3 | x11501==4 | x11501==6 | x11501==20 | x11501==21 | x11501==22 | x11501==26 ///
	| x11331==1 | x11431==1 | x11531==1 | x11325==1 | x11425==1 | x11525==1))
	
replace pmopup = 0 if (x11559>0 & x11300~=0 & x11400~=0 & x11500~=0 & x11331~=0 & x11431~=0 & x11531~=0)
...
generate dbplancj = 1 if(x11000==4 & x11001~=30) | x11001==1 | (x11100==4 & x11101~=30)|x11101==1|(x11200==4 & x11201~=30)| x11201==1 | (x11300==4 & x11301~=30) | x11301==1 | (x11400==4 & x11401~=30) | x11401==1 | (x11500==4 & x11501~=30) | x11501==1 | (x5316==1 & x6461==5) | (x5324==1 & x6466==5) | (x5332==1 & x6471==5) | (x5416==1 & x6476==5) | (x5424==1 & x6481==5) | (x5432==1 & x6486==5) 
...
generate dcplancj = 1 if x11032>0 | x11132>0 | x11232>0 | x11332>0 | x11432>0 | x11532>0 | x11032==-1 | x11132==-1 | x11232==-1 | x11332==-1 | x11432==-1 | x11532==-1 | (x5316==1 & x6461==1) | (x5324==1 & x6466==1) | (x5332==1 & x6471==1) | (x5416==1 & x6476==1) | (x5424==1 & x6481==1) | (x5432==1 & x6486==1)
...
generate equity_in_stock = stocks + stock_mutual_funds + .5*combination_mutual_funds ///
     + other_mutual_funds + (x6551+x6552+x6553+x6554)*((x6555==1)+(x6555==3)*x6556/10000) ///
...
generate reteq =((0+x6551+x6552+x6553+x6554)*((x6555==1)+(x6555==3)*x6556/10000) ///
                +(0+x6559+x6560+x6561+x6562)*((x6563==1)+(x6563==3)*x6564/10000) ///
				+(0+x6567+x6568+x6569+x6570)*((x6571==1)+(x6571==3)*x6572/10000)) ///
...
generate pension_loan_3 = max(0,x11227)*(x11270==5)
generate pension_loan_4 = max(0,x11327)*(x11370==5)
generate pension_loan_5 = max(0,x11427)*(x11470==5)
generate pension_loan_6 = max(0,x11527)*(x11570==5)
...
generate net_worth_percentile = 1 in 1/4190
replace net_worth_percentile = 2 in 4191/8051
replace net_worth_percentile = 3 in 8052/11815
replace net_worth_percentile = 4 in 11816/14579
replace net_worth_percentile = 5 in 14580/22090           //These numbers are adjusted to frequency weights//
