...
generate income2 = 1 in 1/3320
replace income2 = 2 in 3321/6500
replace income2 = 3 in 6501/9763
replace income2 = 4 in 9764/13134
replace income2 = 5 in 13135/15069
replace income2 = 6 in 15070/21525
...
generate equity_in_stock = stocks+stock_mutual_funds+.5*combination_mutual_funds ///
	   ...
	   + trusts*((x6841==1)+.5*(x6841==5 | x6841==6)+.3*(x6841==-7)) + peneq
...
generate net_worth_percentile = 1 in 1/4442
replace net_worth_percentile = 2 in 4443/8160
replace net_worth_percentile = 3 in 8161/11834
replace net_worth_percentile = 4 in 11835/14648
replace net_worth_percentile = 5 in 14649/21525 
